...
const SafeAreaCustomView = (props) => {
  return (
    ...
    <SafeAreaView style={[styles.container, props.SafeAreaViewStyle, { backgroundColor: props.backgroundColor ? props.backgroundColor : "white" }]}>
      <View style={[styles.container, { backgroundColor: 'transparent', width: '100%' }, props.SafeAreaViewStyle,]}>
        {StatusBarView(props)}
        {props.children}
      </View>
    </SafeAreaView>
...
const StatusBarView = (props) => {
  return (
    <StatusBar
      ...
      backgroundColor={props.androidStatusBackColor ? props.androidStatusBackColor : colors.white} //For android
    />
  );
};
